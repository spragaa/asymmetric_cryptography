...
fn main() {
    ...
    println!("0x{:X}", user.public_key_e);
    println!("\nPublic Modulus (N):");
    println!("0x{:X}", user.public_key_n);
    println!("\nPrivate Key (D):");
    println!("0x{:X}", user.private_key_d);
    ...
    println!("Server Public Exponent (E): 0x{:X}", server_e);
    println!("Server Public Modulus (N): 0x{:X}", server_n);
    ...
    println!("0x{:X}", en_message);

    let decrypted = user.decrypt(&en_message, &d, &n);
    println!("\nDecrypted Result:");
    println!("0x{:X}", decrypted);
    ...
    println!("Sent Key:");
    println!("0x{:X}", sent_key);
    println!("\nSent Signature:");
    println!("0x{:X}", sent_signature);
